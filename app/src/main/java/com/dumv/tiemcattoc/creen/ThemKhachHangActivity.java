...
public class ThemKhachHangActivity extends AppCompatActivity implements ApiRunSQL {
    ...
    private void setUp() {
        if (khachHang != null) {
            ...
            if (khachHang.gt) {
                gt = true;
                txvNam.setTextColor(ThemKhachHangActivity.this.getResources().getColor(R.color.xanh));
                ...
                gt = false;
                txvNu.setTextColor(ThemKhachHangActivity.this.getResources().getColor(R.color.xanh));
    ...
    @Override
    public void biloi() {
        thongBao("Khời động lại app để load");
    }
}
